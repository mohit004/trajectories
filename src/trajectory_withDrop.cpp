...
#include <trajectories/set_trajectory_withDropConfig.h>

double sampleTime = 0.01;

void dynamicReconfigureCallback(trajectories::set_trajectory_withDropConfig &config, uint32_t level)
{
...
int main(int argc, char **argv)
{
    ...
    dynamic_reconfigure::Server<trajectories::set_trajectory_withDropConfig> server;
    dynamic_reconfigure::Server<trajectories::set_trajectory_withDropConfig>::CallbackType f;
